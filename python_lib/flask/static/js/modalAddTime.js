...
<input type="hidden" id="res1" value="` + moment().minute(m).format('Y-M-DD[T]HH:mm') + `">
<p>End time and date:</p>
<div id="picker-end"> </div>
<input type="hidden" id="res2" value="` + moment().minute(m).format('Y-M-DD[T]HH:mm') + `">
<br>
...
$('#picker-start').dateTimePicker({
    ...
    buttonTitle: "Select",
    selectData: moment().minute(m).format('Y-M-DD[T]HH:mm')
});
